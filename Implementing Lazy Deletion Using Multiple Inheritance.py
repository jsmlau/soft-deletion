...
class TheTreeNode:
    ...
    def __init__(self, sib=None, first_child=None, prev=None, root=None):
        # instance attributes
        self.sib, self.first_child, self.prev, self.my_root = sib, first_child, prev, root
...
class TheTree:
    ...
    def remove_node_rec(self, node_to_delete):
        """Node_to_delete points to node in tree to be removed (along w/entire subtree). Deletes children recursively
    ...
    def remove_at_cur(self):
        """Calls remove_node() passing cur, and resets cur handles all errors here to avoid repetition in rec call.
    ...
    def add_child_node_to_cur(self, to_add=None):
        ...
        Returns:
            Return None (error) or ref to newly created node expect parent == None IFF tree is empty.
        """
        ...
        ta.sib, ta.first_child, ta.prev, ta.my_root = cur.first_child, None, cur, self.m_root
        cur.first_child = ta
    ...
    def str_recurse(self, tree_node, level=0):
        """Recursive tree stringizer (with indentation) for subtree with root tree_node in this instance's tree
    ...
    def valid_node_in_tree(self, am_i_valid):
        ...
        """
        return isinstance(am_i_valid, TheTreeNode) and (am_i_valid.my_root is self.m_root)
...
class TheDataTreeNode(TheTreeNode):
    """ TheDataTreeNode subclass of TheTreeNode. It is the node class for a data tree.
...
class TheDataTree(TheTree):
    ...
    def find(self, x):
        ...
        Returns:
            If found and valid, current will point to it and return T, else current None and return F (all done by find_rec())
        """
    ...
    def find_in_cur_subtree(self, x):
        ...
        Returns:
            If x valid and found, current will point to it and return T, else current None and return F
        """
    ...
    def find_rec(self, x, root):
        ...
        Returns:
            If found, current set to node and returned, else current/return = None.
        """
    ...
    def remove(self, x):
        ...
        Returns:
            If the node is valid and is found, remove node, return T (cur reset by base call, remove_at_cur()). else curr = None and return F
...
class TheSdTree(TheTree):
    ...
    def remove_at_cur(self):
        """Overridden method to mark self.current's del flag and chk current dltd
    ...
    def add_child_node_to_cur(self, to_add=None):
        ...
        Returns:
            If the node to be added is valid, return super(). Return False otherwise.
...
class TheSdDataTree(TheSdTree, TheDataTree):
    ...
    def add_child_to_cur(self, x):
        ...
        Returns:
            self.add_child_node_to_cur(new_node) if x is valid. False otherwise.
